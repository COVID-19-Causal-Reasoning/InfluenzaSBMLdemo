...
```{r}
pathways_VN1203vsMock_zscore_inputCarnival <- readRDS(file = 
    "IntermediateFiles/pathways_VN1203vsMock_zscore_inputCarnival.rds")
tf_activities_VN1203vsMock_stat <- 
    readRDS(file = "IntermediateFiles/tf_activities_VN1203vsMock_stat.rds")
```
...
### VN1203
tf_activities_VN1203vsMock_stat_top50 <- tf_activities_VN1203vsMock_stat %>% 
  as.data.frame() %>% 
...
CarnivalResults_VN1203vsMock <-runCARNIVAL(
   ...
   #solverPath="/Library/gurobi900/mac64/bin/gurobi_cl",
    ...
    measObj=as.data.frame(tf_activities_VN1203vsMock_stat_top50),
    # inputObj = inputObj,
    # DOTfig=TRUE, 
    ...
    timelimit = 12000,
    solver = "cplex")
saveRDS(CarnivalResults_VN1203vsMock, file = "ResultsCARNIVAL_cplex/VN1203_noinput.rds")
OutputCyto(CarnivalResults_VN1203vsMock, 
  outputFile="ResultsCARNIVAL_cplex/VN1203_noinput")
```
