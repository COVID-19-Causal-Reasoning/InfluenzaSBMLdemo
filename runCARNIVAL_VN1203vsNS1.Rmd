...
if ( argv$perturbation_file == "NoInput"){
  perturbation_file = NULL
} else {
  perturbation_file = argv$perturbation_file
}
...
CarnivalResults <-runCARNIVAL(
   ...
   #solverPath="/Library/gurobi900/mac64/bin/gurobi_cl",
    ...
    inputObj = argv$perturbation_file,
    # DOTfig=TRUE, 
    ...
    solver = argv$solver)
if 
saveRDS(CarnivalResults, file = paste0(argv$outdir, "/", argv$variable, "vs", argv$baseline, "_for_", argv$constant, "_"))
...
```{r}
CarnivalResults_VN1203vsNS1_at_7h_noinput <- CarnivalResults_VN1203vsNS1_noinput
